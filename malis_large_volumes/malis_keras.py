...
class Malis:
    ...
    def pairs_to_loss_keras(self, pairs, pred):
        ...
        # set pos or neg counts to zero depending on which are smaller
#        pos_pairs = tf.where(pos_pairs > neg_pairs, ones_helpervar, zeros_helpervar)
#        neg_pairs = tf.where(neg_pairs > pos_pairs, ones_helpervar, zeros_helpervar)
    ...
    def pairs_to_loss_python(self, pairs, pred):
        ...
        # set pos or neg counts to zero depending on which are smaller
#        pos_pairs = np.where(pos_pairs > neg_pairs, ones_helpervar, zeros_helpervar)
#        neg_pairs = np.where(neg_pairs > pos_pairs, ones_helpervar, zeros_helpervar)
